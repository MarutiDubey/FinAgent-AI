...
class CanvAscii {
  ...
  animate() {
    const animateFrame = () => { this.animationFrameId = requestAnimationFrame(animateFrame); this.render(); };
    animateFrame();
  }
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          background-image: radial-gradient(135deg, #10b981 0%, #3b82f6 55%, #8b5cf6 100%);
